...
<section >
 ...
 <td><p style="font-size: 25px;font-family: Arial, Helvetica, sans-serif ;color: rgb(108, 108, 202);line-height: 15%">DR.{{$personal[0]->nombre}} {{$personal[0]->apellidopaterno}} {{$personal[0]->apellidomaterno}}</p>
  ...
  <p style="font-size: 20px;font-family: cursive;line-height: 15%">{{$cita[0]->paciente->genero}} </p></td> 
</article>
